...
const FilterSidebar = ({ onFilterChange, collection }) => {
    const [searchParams, setSearchParams] = useSearchParams();
    const navigate = useNavigate();
    const [filters, setFilters] = useState({
        category: "",
        gender: collection === 'men' ? 'Men' : collection === 'women' ? 'Women' : "",
        color: "",
        size: [],
        material: [],
        brand: [],
    ...
    useEffect(() => {
        ...
        setFilters({
            ...
            gender: params.gender || (collection === 'men' ? 'Men' : collection === 'women' ? 'Women' : ""),
            color: params.color || "",
